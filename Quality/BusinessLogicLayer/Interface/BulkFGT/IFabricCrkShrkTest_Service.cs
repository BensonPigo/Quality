...
namespace BusinessLogicLayer.Interface
{
    public interface IFabricCrkShrkTest_Service
    {
        ...
        BaseResult EncodeFabricCrkShrkTestHeatDetail(long ID, out string ovenTestResult);
        ...
        BaseResult EncodeFabricCrkShrkTestWashDetail(long ID, out string ovenTestResult);
