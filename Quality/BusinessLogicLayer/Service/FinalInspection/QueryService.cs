        ...
        public Report_Result QueryReport(QueryFinalInspection_ViewModel model)
        {
            ...
            try
            {
                ...
                foreach (var item in finalInspections)
                {
                    ...
                    worksheet.Cells[start_row, 5] = item.SubmitDate;
                    worksheet.Cells[start_row, 6] = item.SampleSize;
                    worksheet.Cells[start_row, 7] = item.SPQty;
                    worksheet.Cells[start_row, 8] = item.StyleID;
                    worksheet.Cells[start_row, 9] = item.Season;
                    worksheet.Cells[start_row, 10] = item.BrandID;
                    worksheet.Cells[start_row, 11] = item.Article;
                    worksheet.Cells[start_row, 12] = item.InspectionTimes;
                    worksheet.Cells[start_row, 13] = item.InspectionStage;
                    worksheet.Cells[start_row, 14] = item.IsTransferToPMS;
                    worksheet.Cells[start_row, 15] = item.IsTransferToPivot88;
