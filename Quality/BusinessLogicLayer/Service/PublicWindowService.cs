...
namespace BusinessLogicLayer.Service
{
    public class PublicWindowService
    {
        ...
        public Window_FabricCrocking Get_FabricCrockingPicture(string ReportNo)
        {
            Window_FabricCrocking result = new Window_FabricCrocking();
            ...
            try
            {
                ...
                //取得登入資訊
                var r = _Provider.Get_FabricCrockingPicture(ReportNo).ToList();
                if (r.Any())
                {
                    result = r.FirstOrDefault();
                }
