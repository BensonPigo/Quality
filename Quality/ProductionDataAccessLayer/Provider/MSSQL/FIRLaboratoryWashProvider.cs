...
{
    public class FIRLaboratoryWashProvider : SQLDAL, IFIRLaboratoryWashProvider
    {
        #region 底層連線
        public FIRLaboratoryWashProvider(string ConString) : base(ConString) { }
        public FIRLaboratoryWashProvider(SQLDataTransaction tra) : base(tra) { }
        #endregion

		#region CRUD Base
		/*回傳Laboratory - WashTest(Get) 詳細敘述如下*/
        /// <summary>
        /// 回傳Laboratory - WashTest
        /// </summary>
        /// <param name="Item">Laboratory - WashTest成員</param>
        /// <returns>回傳Laboratory - WashTest</returns>
        ...
        /// </history>
        public IList<FIR_Laboratory_Wash> Get(FIR_Laboratory_Wash Item)
        {
            ...
            SbSql.Append("        ,SkewnessTest1"+ Environment.NewLine);
            SbSql.Append("        ,SkewnessTest2"+ Environment.NewLine);
            ...
            return ExecuteList<FIR_Laboratory_Wash>(CommandType.Text, SbSql.ToString(), objParameter);
        }
		/*建立Laboratory - WashTest(Create) 詳細敘述如下*/
        /// <summary>
        /// 建立Laboratory - WashTest
        /// </summary>
        /// <param name="Item">Laboratory - WashTest成員</param>
        ...
        /// 01.  2021/08/25  1.00    Admin        Create
        /// </history>
        public int Create(FIR_Laboratory_Wash Item)
        {
            StringBuilder SbSql = new StringBuilder();
            SQLParameterCollection objParameter = new SQLParameterCollection();
            SbSql.Append("INSERT INTO [FIR_Laboratory_Wash]"+ Environment.NewLine);
            ...
            SbSql.Append("        ,@SkewnessTest1"); objParameter.Add("@SkewnessTest1", DbType.String, Item.SkewnessTest1);
            SbSql.Append("        ,@SkewnessTest2"); objParameter.Add("@SkewnessTest2", DbType.String, Item.SkewnessTest2);
            SbSql.Append("        ,@SkewnessTest3"); objParameter.Add("@SkewnessTest3", DbType.String, Item.SkewnessTest3);
            SbSql.Append("        ,@SkewnessTest4"); objParameter.Add("@SkewnessTest4", DbType.String, Item.SkewnessTest4);
            SbSql.Append("        ,@SkewnessRate"); objParameter.Add("@SkewnessRate", DbType.String, Item.SkewnessRate);
            SbSql.Append(")"+ Environment.NewLine);
		...
		/*更新Laboratory - WashTest(Update) 詳細敘述如下*/
        /// <summary>
        /// 更新Laboratory - WashTest
        /// </summary>
        /// <param name="Item">Laboratory - WashTest成員</param>
        /// <returns>回傳異動筆數</returns>
		/// <info>Author: Admin; Date: 2021/08/25  </info>
        ...
        /// 01.  2021/08/25  1.00    Admin        Create
        /// </history>
        public int Update(FIR_Laboratory_Wash Item)
        {
            StringBuilder SbSql = new StringBuilder();
            SQLParameterCollection objParameter = new SQLParameterCollection();
            SbSql.Append("UPDATE [FIR_Laboratory_Wash]"+ Environment.NewLine);
            ...
            if (Item.SkewnessTest1 != null) { SbSql.Append(",SkewnessTest1=@SkewnessTest1"+ Environment.NewLine); objParameter.Add("@SkewnessTest1", DbType.String, Item.SkewnessTest1);}
            if (Item.SkewnessTest2 != null) { SbSql.Append(",SkewnessTest2=@SkewnessTest2"+ Environment.NewLine); objParameter.Add("@SkewnessTest2", DbType.String, Item.SkewnessTest2);}
            if (Item.SkewnessTest3 != null) { SbSql.Append(",SkewnessTest3=@SkewnessTest3"+ Environment.NewLine); objParameter.Add("@SkewnessTest3", DbType.String, Item.SkewnessTest3);}
            if (Item.SkewnessTest4 != null) { SbSql.Append(",SkewnessTest4=@SkewnessTest4"+ Environment.NewLine); objParameter.Add("@SkewnessTest4", DbType.String, Item.SkewnessTest4);}
            if (Item.SkewnessRate != null) { SbSql.Append(",SkewnessRate=@SkewnessRate"+ Environment.NewLine); objParameter.Add("@SkewnessRate", DbType.String, Item.SkewnessRate);}
		...
		/*刪除Laboratory - WashTest(Delete) 詳細敘述如下*/
        /// <summary>
        /// 刪除Laboratory - WashTest
        /// </summary>
        /// <param name="Item">Laboratory - WashTest成員</param>
        /// <returns>回傳異動筆數</returns>
		/// <info>Author: Admin; Date: 2021/08/25  </info>
        ...
        /// 01.  2021/08/25  1.00    Admin        Create
        /// </history>
        public int Delete(FIR_Laboratory_Wash Item)
        {
            StringBuilder SbSql = new StringBuilder();
            SQLParameterCollection objParameter = new SQLParameterCollection();
            SbSql.Append("DELETE FROM [FIR_Laboratory_Wash]"+ Environment.NewLine);
