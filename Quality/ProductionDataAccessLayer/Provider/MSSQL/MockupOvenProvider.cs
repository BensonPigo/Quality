...
namespace ProductionDataAccessLayer.Provider.MSSQL
{
    public class MockupOvenProvider : SQLDAL, IMockupOvenProvider
    {
        ...
        public IList<MockupOven> Get(MockupOven Item)
        {
            ...
            SbSql.Append("FROM [MockupOven]" + Environment.NewLine);
        ...
        public void Update(MockupOven_ViewModel Item)
        {
            ...
            if (Item.EditName != null) { SbSql.Append(",EditName=@EditName" + Environment.NewLine); objParameter.Add("@EditName", DbType.String, HttpUtility.HtmlDecode(Item.EditName) ?? string.Empty); }
            ...
            if (Item.HTCoolingTime != null) { SbSql.Append(",HTCoolingTime=@HTCoolingTime" + Environment.NewLine); objParameter.Add("@HTCoolingTime", DbType.Int32, Item.HTCoolingTime); }
...
";
        ...
        public IList<MockupOven_ViewModel> GetMockupOvenReportNoList(MockupOven_Request Item)
        {
            StringBuilder SbSql = new StringBuilder();
            SQLParameterCollection objParameter = new SQLParameterCollection();
            SbSql.Append(@"
