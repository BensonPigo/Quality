...
namespace ProductionDataAccessLayer.Provider.MSSQL
{
    public class PerspirationFastnessProvider : SQLDAL
    {
        ...
        public PerspirationFastness_Detail_Result GetPerspirationFastness_Detail(string poID, string TestNo, string BrandID = "")
        {
            ...
            if (string.IsNullOrEmpty(TestNo))
            {
                ...
                PerspirationFastness_Detail_Result.Main.BrandID = BrandID;
