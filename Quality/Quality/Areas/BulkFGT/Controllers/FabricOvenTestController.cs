...
namespace Quality.Areas.BulkFGT.Controllers
{
    public class FabricOvenTestController : BaseController
    {
        ...
        public ActionResult AddDetailRow(string POID, int lastNO, string GroupNO, string BrandID)
        {
            ...
            string html = "";
            html += "<tr idx='" + i + "'>";
            html += "<td><input id='Seq" + i + "' idx='" + i + "' type ='hidden'></input><input id='Details_" + i + "__OvenGroup' name='Details[" + i + "].OvenGroup' type='number' max='99' maxlength='2' min='0' step='1' oninput='value=OvenGroupCheck(value)' value='" + GroupNO + "'></td>"; // group
